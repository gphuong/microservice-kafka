...
@SpringBootTest(classes = ShippingTestApp.class, webEnvironment = SpringBootTest.WebEnvironment.NONE)
@ActiveProfiles("test")
...
public class ShipmentKafkaTest {
    ...
    @Test
    public void orderAreReceived() throws InterruptedException {
